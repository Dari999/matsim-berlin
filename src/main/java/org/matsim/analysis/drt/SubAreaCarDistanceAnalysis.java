...
/**
 * copy of: https://github.com/matsim-vsp/pave/blob/master/src/main/java/org/matsim/analysis/SubAreaCarDistanceAnalysis.java
 */

public class SubAreaCarDistanceAnalysis {

    final static String networkFile = "/Users/dariush/output/drtNetwork-loopLinksPShortIntersection.xml";
...
//		runIDs.add("p2-32");
        ...
        runIDs.forEach(runID -> processRun());
    }
...
//        String outputFileName = root + scenario + "/output-" + runID + "/" + runID + ".subAreaCarKm.txt";
		...
		String eventsFile =  "/Users/dariush/output/output-events/clusterStops250AllLinks-2000vehicles-4seats.output_events.xml.gz";
		String outputFileName = "/Users/dariush/output/clusterStops250AllLinks-totalCarKm.txt";
